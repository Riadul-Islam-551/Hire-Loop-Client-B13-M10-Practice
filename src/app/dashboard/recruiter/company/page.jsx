...
import {
  Plus, Factory, MapPin, Persons, ChevronsRight,
  Pencil, Check, Xmark, CloudArrowUpIn, Text,
} from "@gravity-ui/icons";
import {
  Form, TextField, Label, Input, FieldError,
  Button, Card, Chip,
} from "@heroui/react";
...
export default function CompanyProfileManager() {
  ...
  const handleFormSubmit = async (e) => {
    ...
    const data = {};
    formElements.forEach((value, key) => { data[key] = value.toString(); });
          ...
          <Card.Content className="p-6 md:p-8">
            <div className="mb-6">
              <h2 className="text-2xl font-bold text-foreground">
                {companyData ? "Update Company Information" : "Company Profile Registration"}
              </h2>
              <p className="text-xs text-default-400 mt-1">
                Provide clear workspace parameters for candidates looking at your jobs.
              </p>
            </div>
            ...
            <Form className="flex flex-col gap-6" onSubmit={handleFormSubmit}>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-5 p-4 bg-default-50 rounded-xl border-1 border-default-100">
                <div className="w-20 h-20 bg-default-200 rounded-xl overflow-hidden flex items-center justify-center border border-default-300">
                  {imagePreview ? (
                    ...
                    <Factory width={28} height={28} className="text-default-400" />
                  )}
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <TextField isRequired name="companyName" defaultValue={companyData?.name || ""}>
                ...
                <TextField isRequired name="industry" defaultValue={companyData?.industry || ""}>
                ...
                <TextField isRequired name="location" defaultValue={companyData?.location || ""}>
                  <Label className="text-xs font-semibold text-foreground">HQ Location</Label>
                  <Input
                ...
                <TextField isRequired name="employeeCount" defaultValue={companyData?.employeeCount || ""}>
                  <Label className="text-xs font-semibold text-foreground">Employee Size</Label>
                  <Input
              ...
              <TextField isRequired name="description" defaultValue={companyData?.description || ""}>
                <Label className="text-xs font-semibold text-foreground">Company Overview</Label>
                <Input
                  placeholder="Describe your corporate history, core products or tech stacks..."
                  variant="bordered"
                  startContent={<Text className="text-default-400 self-start mt-2.5" />}
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-end gap-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm font-medium text-primary flex items-center gap-1">
                  <ChevronsRight width={14} height={14} /> {companyData.industry}
                </p>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
            <div className="flex items-center gap-3 p-3 bg-default-50 rounded-xl border border-default-100">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-foreground">{companyData.location}</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 p-3 bg-default-50 rounded-xl border border-default-100">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-foreground">{companyData.employeeCount}</p>
              </div>
            </div>
          </div>
